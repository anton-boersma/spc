...
class DashboardModule(Module):
    ...
    def __init__(self, frequency: FrequencyModule, gas_pedal, brake_pedal, steering_wheel, steering_module: SteeringModule, display_mode: int):
